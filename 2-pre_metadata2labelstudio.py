...
if __name__ == '__main__':
    metadata_path = r"D:\Code\ML\Audio\card_audio_data01\pre_metadata.csv"
    you_id = '38'

    label_studio_cache_path = os.path.join(USER_PATH, r"AppData\Local\label-studio\label-studio\media\upload", you_id)
    ...
    data_save_path = os.path.join(os.path.split(metadata_path)[0], 'pre_metadata2labelstudio.csv')
