...
if __name__ == '__main__':
    ...
    common_voice["train"] = load_dataset("audiofolder", data_dir=dataset_name, split="train")
    common_voice["test"] = load_dataset("audiofolder", data_dir=dataset_name, split="train")
